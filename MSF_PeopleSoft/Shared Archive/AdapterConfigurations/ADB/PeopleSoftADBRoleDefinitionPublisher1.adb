...
<Repository:repository xmlns:Repository="http://www.tibco.com/xmlns/repo/types/2002" xmlns:AESDK="http://www.tibco.com/xmlns/aemeta/adapter/2002" xmlns:AEService="http://www.tibco.com/xmlns/aemeta/services/2002" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
    <ADB:adapter xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002" name="PeopleSoftADBRoleDefinitionPublisher1">
        <AESDK:instanceId>PeopleSoftADBRoleDefinitionPublisher1</AESDK:instanceId>
        <AESDK:startup>
            ...
            <AESDK:startComponent>
                <AESDK:state>active</AESDK:state>
                <AESDK:name>ADBRoleDefnPublisher</AESDK:name>
            </AESDK:startComponent>
        </AESDK:startup>
        <AESDK:deployment>
            ...
            <AESDK:producers>
                <AESDK:jmsPublisher isRef="true">#jmsProducer.ADBRoleDefnPublisher</AESDK:jmsPublisher>
            </AESDK:producers>
        </AESDK:deployment>
        ...
        <AESDK:metadata>
            ...
            <AESDK:loadUrl isRef="true">/AESchemas/ae/ADB/PeopleSoftADBRoleDefinitionPublisher1.aeschema</AESDK:loadUrl>
        </AESDK:metadata>
        ...
        <AESDK:designer>
            ...
            <AESDK:lockedProperties>
                ...
                <AESDK:locked>
                    <AESDK:resource>/Advanced/Sessions/JMSQueue/ADBRoleDefnPublisher</AESDK:resource>
            ...
            <AESDK:fixedChildren>
                ...
                <AESDK:fixed>
                    <AESDK:resource>/Advanced/Sessions/JMSQueue</AESDK:resource>
                    <AESDK:children>ADBRoleDefnPublisher</AESDK:children>
                </AESDK:fixed>
                <AESDK:fixed>
                    <AESDK:resource>/Advanced/Sessions/JMSQueue/ADBRoleDefnPublisher</AESDK:resource>
                    <AESDK:children>P_PSOPRDEFN</AESDK:children>
                </AESDK:fixed>
            </AESDK:fixedChildren>
            <AESDK:resourceDescriptions>
                <AESDK:node>
                    <AESDK:resource>/Advanced/Sessions/JMSQueue/ADBRoleDefnPublisher</AESDK:resource>
                    <AESDK:description>Created for service ADBRoleDefnPublisher.</AESDK:description>
                </AESDK:node>
            </AESDK:resourceDescriptions>
            <AESDK:adapterTester>
                <AESDK:exe>C:\tibco\adapter\adadb\7.1\bin\adbagent.exe</AESDK:exe>
                <AESDK:args>--run --propFile</AESDK:args>
                <AESDK:workingDir>d:\temp\log</AESDK:workingDir>
            </AESDK:adapterTester>
        </AESDK:designer>
        ...
        <ADB:operations xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002">
            <ADB:publisher xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002" resourceType="adb.table.publisher">
                ...
                <ADB:name>ADBRoleDefnPublisher</ADB:name>
                ...
                <ADB:publishingTable>P_PSOPRDEFN</ADB:publishingTable>
                <ADB:classReference isRef="true">/AESchemas/ae/ADB/PeopleSoftADBRoleDefinitionPublisher1.aeschema#class.P_PSOPRDEFN</ADB:classReference>
                <ADB:sourceTable>PSOPRDEFN</ADB:sourceTable>
                <ADB:destination>%%MSF/REGION%%.%%MSF/ENV%%.%%MSF/JMS/Type/Request%%.%%Destinations/Queues/Customer/CustomerAccount/CustomerAccountManagement/MCPeopleSoft_v1/LDAPRoleDefnSync%%</ADB:destination>
                <ADB:endpointReference isRef="true">#jmsProducer.ADBRoleDefnPublisher</ADB:endpointReference>
                <ADB:repoEndpointType>endpoint.JMSPublisher</ADB:repoEndpointType>
                <ADB:sessionReference>/AdapterConfigurations/ADB/PeopleSoftADBRoleDefinitionPublisher1.adb#jmsSession.JMSQueue</ADB:sessionReference>
                <ADB:columnsToPublish>OPRID</ADB:columnsToPublish>
                <ADB:columnsToPublish>VERSION</ADB:columnsToPublish>
                <ADB:columnsToPublish>OPRDEFNDESC</ADB:columnsToPublish>
                <ADB:columnsToPublish>EMPLID</ADB:columnsToPublish>
                <ADB:columnsToPublish>EMAILID</ADB:columnsToPublish>
                <ADB:columnsToPublish>OPRCLASS</ADB:columnsToPublish>
                <ADB:columnsToPublish>ROWSECCLASS</ADB:columnsToPublish>
                <ADB:columnsToPublish>OPERPSWD</ADB:columnsToPublish>
                <ADB:columnsToPublish>ENCRYPTED</ADB:columnsToPublish>
                <ADB:columnsToPublish>SYMBOLICID</ADB:columnsToPublish>
                <ADB:columnsToPublish>LANGUAGE_CD</ADB:columnsToPublish>
                <ADB:columnsToPublish>MULTILANG</ADB:columnsToPublish>
                <ADB:columnsToPublish>CURRENCY_CD</ADB:columnsToPublish>
                <ADB:columnsToPublish>LASTPSWDCHANGE</ADB:columnsToPublish>
                <ADB:columnsToPublish>ACCTLOCK</ADB:columnsToPublish>
                <ADB:columnsToPublish>PRCSPRFLCLS</ADB:columnsToPublish>
                <ADB:columnsToPublish>DEFAULTNAVHP</ADB:columnsToPublish>
                <ADB:columnsToPublish>FAILEDLOGINS</ADB:columnsToPublish>
                <ADB:columnsToPublish>EXPENT</ADB:columnsToPublish>
                <ADB:columnsToPublish>OPRTYPE</ADB:columnsToPublish>
                <ADB:columnsToPublish>USERIDALIAS</ADB:columnsToPublish>
                <ADB:columnsToPublish>LASTSIGNONDTTM</ADB:columnsToPublish>
                <ADB:columnsToPublish>LASTUPDDTTM</ADB:columnsToPublish>
                <ADB:columnsToPublish>LASTUPDOPRID</ADB:columnsToPublish>
                <ADB:columnsToPublish>PTALLOWSWITCHUSER</ADB:columnsToPublish>
                <ADB:userDefinedKey>OPRID</ADB:userDefinedKey>
                <ADB:schemas xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002">
                    <ADB:table xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002">
                        <ADB:name>P_PSOPRDEFN</ADB:name>
                        <ADB:userKeys>OPRID</ADB:userKeys>
                    </ADB:table>
                </ADB:schemas>
            </ADB:publisher>
        </ADB:operations>
        <ADB:activedb xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002">
            <ADB:defaultDataSource xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002">
                ...
                <ADB:defaultSchema>PSFTADM</ADB:defaultSchema>
            ...
            <ADB:agentOptions xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002">
                ...
                <ADB:scriptFileName>%%ADBScriptFileDir%%\PeopleSoftADBRoleDefinitionPublisher1.sql</ADB:scriptFileName>
    ...
    <AEService:jmsProducer xmlns:AEService="http://www.tibco.com/xmlns/aemeta/services/2002" objectType="endpoint.JMSPublisher" name="ADBRoleDefnPublisher">
        ...
        <AEService:destination>%%MSF/REGION%%.%%MSF/ENV%%.%%MSF/JMS/Type/Request%%.%%Destinations/Queues/Customer/CustomerAccount/CustomerAccountManagement/MCPeopleSoft_v1/LDAPRoleDefnSync%%</AEService:destination>
        <AEService:class isRef="true">/AESchemas/ae/ADB/PeopleSoftADBRoleDefinitionPublisher1.aeschema#class.P_PSOPRDEFN</AEService:class>
