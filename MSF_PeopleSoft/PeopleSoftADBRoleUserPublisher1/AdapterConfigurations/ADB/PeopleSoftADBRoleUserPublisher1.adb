...
<Repository:repository xmlns:Repository="http://www.tibco.com/xmlns/repo/types/2002" xmlns:AESDK="http://www.tibco.com/xmlns/aemeta/adapter/2002" xmlns:AEService="http://www.tibco.com/xmlns/aemeta/services/2002" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
    <ADB:adapter xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002" name="PeopleSoftADBRoleUserPublisher1">
        <AESDK:instanceId>PeopleSoftADBRoleUserPublisher1</AESDK:instanceId>
        <AESDK:startup>
            ...
            <AESDK:startComponent>
                <AESDK:state>active</AESDK:state>
                <AESDK:name>ADBRoleUserPublisher</AESDK:name>
            </AESDK:startComponent>
        </AESDK:startup>
        <AESDK:deployment>
            ...
            <AESDK:producers>
                <AESDK:jmsPublisher isRef="true">#jmsProducer.ADBRoleUserPublisher</AESDK:jmsPublisher>
            </AESDK:producers>
        </AESDK:deployment>
        ...
        <AESDK:metadata>
            ...
            <AESDK:loadUrl isRef="true">/AESchemas/ae/ADB/PeopleSoftADBRoleUserPublisher1.aeschema</AESDK:loadUrl>
        </AESDK:metadata>
        ...
        <AESDK:designer>
            ...
            <AESDK:lockedProperties>
                ...
                <AESDK:locked>
                    <AESDK:resource>/Advanced/Sessions/JMSQueue/ADBRoleUserPublisher</AESDK:resource>
            ...
            <AESDK:fixedChildren>
                ...
                <AESDK:fixed>
                    <AESDK:resource>/Advanced/Sessions/JMSQueue</AESDK:resource>
                    <AESDK:children>ADBRoleUserPublisher</AESDK:children>
                </AESDK:fixed>
                <AESDK:fixed>
                    <AESDK:resource>/Advanced/Sessions/JMSQueue/ADBRoleUserPublisher</AESDK:resource>
                    <AESDK:children>P_PSROLEUSER</AESDK:children>
                </AESDK:fixed>
            </AESDK:fixedChildren>
            <AESDK:resourceDescriptions>
                <AESDK:node>
                    <AESDK:resource>/Advanced/Sessions/JMSQueue/ADBRoleUserPublisher</AESDK:resource>
                    <AESDK:description>Created for service ADBRoleUserPublisher.</AESDK:description>
                </AESDK:node>
            </AESDK:resourceDescriptions>
            <AESDK:adapterTester>
        ...
        <ADB:operations xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002">
            <ADB:publisher xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002" resourceType="adb.table.publisher">
                ...
                <ADB:name>ADBRoleUserPublisher</ADB:name>
                ...
                <ADB:publishingTable>P_PSROLEUSER</ADB:publishingTable>
                <ADB:classReference isRef="true">/AESchemas/ae/ADB/PeopleSoftADBRoleUserPublisher1.aeschema#class.P_PSROLEUSER</ADB:classReference>
                <ADB:sourceTable>PSROLEUSER</ADB:sourceTable>
                <ADB:messageSubject>%%Domain%%.%%Deployment%%.adb.PeopleSoftADBRoleUserPublisher1.ADBRoleUserPublisher</ADB:messageSubject>
                <ADB:repoEndpointType>endpoint.JMSPublisher</ADB:repoEndpointType>
                <ADB:sessionReference>/AdapterConfigurations/ADB/PeopleSoftADBRoleUserPublisher1.adb#jmsSession.JMSQueue</ADB:sessionReference>
                <ADB:preRegisteredListeners/>
                <ADB:destination>%%MSF/REGION%%.%%MSF/ENV%%.%%MSF/JMS/Type/Request%%.%%Destinations/Queues/Customer/CustomerAccount/CustomerAccountManagement/MCPeopleSoft_v1/LDAPUserRoleSync%%</ADB:destination>
                <ADB:endpointReference isRef="true">#jmsProducer.ADBRoleUserPublisher</ADB:endpointReference>
                <ADB:columnsToPublish>ROLEUSER</ADB:columnsToPublish>
                <ADB:columnsToPublish>ROLENAME</ADB:columnsToPublish>
                <ADB:columnsToPublish>DYNAMIC_SW</ADB:columnsToPublish>
                <ADB:userDefinedKey>ROLEUSER</ADB:userDefinedKey>
                <ADB:schemas xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002">
                    <ADB:table xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002">
                        <ADB:name>P_PSROLEUSER</ADB:name>
                        <ADB:userKeys>ROLEUSER</ADB:userKeys>
                    </ADB:table>
                </ADB:schemas>
            </ADB:publisher>
        </ADB:operations>
        <ADB:activedb xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002">
            ...
            <ADB:agentOptions xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002">
                ...
                <ADB:scriptFileName>%%ADBScriptFileDir%%\PeopleSoftADBRoleUserPublisher1.sql</ADB:scriptFileName>
    ...
    <AEService:jmsProducer xmlns:AEService="http://www.tibco.com/xmlns/aemeta/services/2002" objectType="endpoint.JMSPublisher" name="ADBRoleUserPublisher">
        ...
        <AEService:destination>%%MSF/REGION%%.%%MSF/ENV%%.%%MSF/JMS/Type/Request%%.%%Destinations/Queues/Customer/CustomerAccount/CustomerAccountManagement/MCPeopleSoft_v1/LDAPUserRoleSync%%</AEService:destination>
        <AEService:class isRef="true">/AESchemas/ae/ADB/PeopleSoftADBRoleUserPublisher1.aeschema#class.P_PSROLEUSER</AEService:class>
