...
<Repository:repository xmlns:Repository="http://www.tibco.com/xmlns/repo/types/2002" xmlns:AESDK="http://www.tibco.com/xmlns/aemeta/adapter/2002" xmlns:AEService="http://www.tibco.com/xmlns/aemeta/services/2002" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
    <ADB:adapter xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002" name="SprintLDAPSecurityRole">
        <AESDK:instanceId>SprintLDAPSecurityRole</AESDK:instanceId>
        <AESDK:startup>
            ...
            <AESDK:startComponent>
                <AESDK:state>active</AESDK:state>
                <AESDK:name>SprintLDAPSecurityRoleService</AESDK:name>
            </AESDK:startComponent>
        </AESDK:startup>
        <AESDK:deployment>
            ...
            <AESDK:producers>
                <AESDK:jmsPublisher isRef="true">#jmsProducer.SprintLDAPSecurityRoleService</AESDK:jmsPublisher>
            </AESDK:producers>
        </AESDK:deployment>
        ...
        <AESDK:metadata>
            ...
            <AESDK:loadUrl isRef="true">/AESchemas/ae/ADB/SprintLDAPSecurityRole.aeschema</AESDK:loadUrl>
        </AESDK:metadata>
        ...
        <AESDK:designer>
            ...
            <AESDK:lockedProperties>
                ...
                <AESDK:locked>
                    <AESDK:resource>/Advanced/Sessions/JMSQueue/SprintLDAPSecurityRoleService</AESDK:resource>
            ...
            <AESDK:fixedChildren>
                ...
                <AESDK:fixed>
                    <AESDK:resource>/Advanced/Sessions/JMSQueue</AESDK:resource>
                    <AESDK:children>SprintLDAPSecurityRoleService</AESDK:children>
                </AESDK:fixed>
                <AESDK:fixed>
                    <AESDK:resource>/Advanced/Sessions/JMSQueue/SprintLDAPSecurityRoleService</AESDK:resource>
                    <AESDK:children>P_SECPRINSECROLE</AESDK:children>
                </AESDK:fixed>
            </AESDK:fixedChildren>
            <AESDK:resourceDescriptions>
                <AESDK:node>
                    <AESDK:resource>/Advanced/Sessions/JMSQueue/SprintLDAPSecurityRoleService</AESDK:resource>
                    <AESDK:description>Created for service SprintLDAPSecurityRoleService.</AESDK:description>
                </AESDK:node>
            </AESDK:resourceDescriptions>
            <AESDK:adapterTester>
        ...
        <ADB:operations xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002">
            <ADB:publisher xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002" resourceType="adb.table.publisher">
                ...
                <ADB:name>SprintLDAPSecurityRoleService</ADB:name>
                ...
                <ADB:publishingTable>P_SECPRINSECROLE</ADB:publishingTable>
                <ADB:classReference isRef="true">/AESchemas/ae/ADB/SprintLDAPSecurityRole.aeschema#class.P_SECPRINSECROLE</ADB:classReference>
                <ADB:sourceTable>SECURITYPRINCIPALSECURITYROLE</ADB:sourceTable>
                <ADB:columnsToPublish>SECURITYPRINCIPALID</ADB:columnsToPublish>
                <ADB:columnsToPublish>SECURITYROLEID</ADB:columnsToPublish>
                <ADB:userDefinedKey>SECURITYPRINCIPALID</ADB:userDefinedKey>
                <ADB:userDefinedKey>SECURITYROLEID</ADB:userDefinedKey>
                <ADB:schemas xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002">
                    <ADB:table xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002">
                        <ADB:name>P_SECURITYPRINCIPALSECURITYROLE</ADB:name>
                    ...
                    <ADB:table xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002">
                        <ADB:name>SECURITYPRINCIPAL</ADB:name>
                        <ADB:userKeys>EMPLOYEEID</ADB:userKeys>
                    </ADB:table>
                </ADB:schemas>
                <ADB:destination>%%MSF/REGION%%.%%MSF/ENV%%.%%MSF/JMS/Type/Request%%.%%Destinations/Queues/Enterprise/EnterpriseSecurity/EnterpriseSecurityAuthentication/UpdateLDAPUser_v1/SprintLDAPSecurityRoleService%%</ADB:destination>
                <ADB:endpointReference isRef="true">#jmsProducer.SprintLDAPSecurityRoleService</ADB:endpointReference>
                <ADB:repoEndpointType>endpoint.JMSPublisher</ADB:repoEndpointType>
                <ADB:sessionReference>/AdapterConfigurations/ADB/SprintLDAPSecurityRole.adb#jmsSession.JMSQueue</ADB:sessionReference>
            </ADB:publisher>
        </ADB:operations>
        <ADB:activedb xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002">
            ...
            <ADB:agentOptions xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002">
                ...
                <ADB:scriptFileName>%%ADBScriptFileDir%%\SprintLDAPSecurityRole.sql</ADB:scriptFileName>
    ...
    <AEService:jmsProducer xmlns:AEService="http://www.tibco.com/xmlns/aemeta/services/2002" objectType="endpoint.JMSPublisher" name="SprintLDAPSecurityRoleService">
        ...
        <AEService:destination>%%MSF/REGION%%.%%MSF/ENV%%.%%MSF/JMS/Type/Request%%.%%Destinations/Queues/Enterprise/EnterpriseSecurity/EnterpriseSecurityAuthentication/UpdateLDAPUser_v1/SprintLDAPSecurityRoleService%%</AEService:destination>
        <AEService:class isRef="true">/AESchemas/ae/ADB/SprintLDAPSecurityRole.aeschema#class.P_SECPRINSECROLE</AEService:class>
